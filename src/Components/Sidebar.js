...
const Sidebar = () => {
    ...
    const setActive = (idx) => {
        ...
        document.getElementById(`taskName-${idx}`).classList.add('board-task-active')
    ...
    return (
        <>
            <div className="sidebar">
                <Row>
                    <Col sm={12} className='boards-text'><p>ALL BOARDS (3)</p></Col>

                    {data.boards.map((board, idx) => (

                        <Col key={idx} id={`taskName-${idx}`} data-active='false' sm={12} onClick={() => setActive(idx)} className='boards-tasks'>
                ...
                <div className='sidebar-actions'>
                    ...
                    <div className='boards-tasks' onClick={() => setHideBar(true)}>    
